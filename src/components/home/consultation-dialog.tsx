    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl bg-[#0a0a0a] border-white/5 p-8 md:p-16 flex flex-col items-center">
        <DialogHeader className="mb-12 w-full text-center">
          <DialogTitle className="text-white text-3xl md:text-[40px] font-extralight tracking-[0.4em] uppercase mb-4 leading-tight">
            Prompt Consultation
          </DialogTitle>
        ...
        <div className="w-full flex flex-col md:flex-row gap-6 md:gap-8 items-end justify-center">
          ...
          <div className="w-full md:w-auto">
            <Button className="border border-[#B8860B] bg-transparent text-[#B8860B] hover:bg-[#B8860B] hover:text-white rounded-none uppercase tracking-[0.3em] font-medium px-10 h-14 text-base transition-all min-w-[150px]">
              Send
            </Button>
          </div>
        </div>
